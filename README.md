...
| 1.8.0 | 3.6 | Ubuntu 16.04 | 2.23 | Intel i7 960 | CPU | `sse` | - | - | [Link](https://storage.googleapis.com/tensorflow-builds/nazgul/cpu/tensorflow-1.8.0-cp36-cp36m-linux_x86_64.whl) |
